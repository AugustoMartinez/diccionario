...
/**
*  Se pide por consola el nombre del texto para así guardarse en el archivo de nombres de textos (Que contiene los nombres junto con sus idDoc)
*  Luego de cargar ese archivo, concatena un .bin a ese nombre así pasa a ser un archivo
...
void cargaTextoDiccionario() {
    ...
    idDoc = contarCantIdDoc(NOMBRESTEXTOS);
